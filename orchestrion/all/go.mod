...
require (
	github.com/DataDog/dd-trace-go/contrib/99designs/gqlgen/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/IBM/sarama/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/Shopify/sarama/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/aws/aws-sdk-go-v2/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/aws/aws-sdk-go/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/cloud.google.com/go/pubsub.v1/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/cloud.google.com/go/pubsub.v2/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/confluentinc/confluent-kafka-go/kafka.v2/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/confluentinc/confluent-kafka-go/kafka/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/database/sql/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/elastic/go-elasticsearch.v6/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gin-gonic/gin/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go-chi/chi.v5/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go-chi/chi/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go-redis/redis.v7/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go-redis/redis.v8/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go-redis/redis/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go.mongodb.org/mongo-driver.v2/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/go.mongodb.org/mongo-driver/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gocql/gocql/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gofiber/fiber.v2/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gomodule/redigo/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gorilla/mux/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/graph-gophers/graphql-go/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/graphql-go/graphql/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/hashicorp/vault/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/jackc/pgx.v5/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/julienschmidt/httprouter/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/k8s.io/client-go/v2 v2.7.0
	...
	github.com/DataDog/dd-trace-go/contrib/redis/rueidis/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/rs/zerolog/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/segmentio/kafka-go/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/sirupsen/logrus/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/twitchtv/twirp/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/valkey-io/valkey-go/v2 v2.7.0
	github.com/DataDog/dd-trace-go/contrib/valyala/fasthttp/v2 v2.7.0
