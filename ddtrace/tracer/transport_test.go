...
func TestTracesAgentIntegration(t *testing.T) {
	...
	for _, tc := range testCases {
		transport := newHTTPTransport(defaultURL+tracesAPIPath, defaultURL, internal.DefaultHTTPClient(defaultHTTPTimeout, false))
...
func TestTransportResponse(t *testing.T) {
	for name, tt := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			...
			defer srv.Close()
			transport := newHTTPTransport(srv.URL+tracesAPIPath, srv.URL, internal.DefaultHTTPClient(defaultHTTPTimeout, false))
...
func TestCustomTransport(t *testing.T) {
	...
	transport := newHTTPTransport(srv.URL+tracesAPIPath, srv.URL, c)
...
func TestConcurrentTraceFlushOverUDS(t *testing.T) {
	...
	transport := newHTTPTransport(udsURL+tracesAPIPath, udsURL, client)
